...
(function () {
  ...
  /* lead form -> /api/dealership (public, no login; emails sales + confirmation,
     lands in admin "Dealers" tab). Tagged clearly as a hospital lead. */
  var API_BASE = (typeof window !== "undefined" && window.DCAL_API_BASE) || "";
  var form = $("#hospitalForm"), note = $("#formNote");
  ...
  if (form) {
    ...
    form.addEventListener("submit", function (e) {
      ...
      var payload = {
        ...
        businessType: "Hospital – " + (raw.facilityType || "Hospital"),
        currentProducts: raw.beds || "",
        message: "[HOSPITAL WATER ASSESSMENT] Facility: " + (raw.businessName || "-")
          + " | Type: " + (raw.facilityType || "-")
          + " | Beds: " + (raw.beds || "-")
