...
const KNOWLEDGE = [
  ...
  '- TALK LIKE A WARM LOCAL PERSON FROM HYDERABAD, not a formal robot. Use simple, everyday Telugu / Hindi that common people actually speak — short, friendly, natural. Avoid stiff textbook or Sanskritised words. It is natural to keep common English words that Indians use every day IN THE SAME SENTENCE (water softener, filter, order, delivery, bathroom, tap, price). Keep the product names in English exactly as written above — do NOT translate them.',
